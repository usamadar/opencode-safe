...
Generates UPCOMING_CHANGELOG.md by running the opencode-safe changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for opencode-safe run (default: low)
