...
export const SIDECAR_BINARIES: Array<{ rustTarget: string; ocBinary: string; assetExt: string }> = [
  {
    ...
    ocBinary: "opencode-safe-darwin-arm64",
    assetExt: "zip",
  },
  {
  ...
  },
  {
    ...
    ocBinary: "opencode-safe-windows-x64-baseline",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-unknown-linux-gnu",
    ocBinary: "opencode-safe-linux-x64-baseline",
    assetExt: "tar.gz",
  },
  {
    rustTarget: "aarch64-unknown-linux-gnu",
    ocBinary: "opencode-safe-linux-arm64",
    assetExt: "tar.gz",
  },
]
...
export async function copyBinaryToSidecarFolder(source: string, target = RUST_TARGET) {
  ...
  const dest = windowsify(`src-tauri/sidecars/opencode-safe-cli-${target}`)
