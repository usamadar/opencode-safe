...
npm i -g opencode-safe@latest        # o bun/pnpm/yarn
scoop install opencode-safe             # Windows
choco install opencode-safe             # Windows
brew install usamadar/tap/opencode-safe # macOS y Linux (recomendado, siempre al día)
brew install opencode-safe              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S opencode-safe            # Arch Linux (Stable)
paru -S opencode-safe-bin               # Arch Linux (Latest from AUR)
mise use -g opencode-safe               # cualquier sistema
nix run nixpkgs#opencode-safe           # o github:usamadar/opencode-safe para la rama dev más reciente
```
...
OpenCode Safe también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/usamadar/opencode-safe/releases) o desde [GitHub Releases](https://github.com/usamadar/opencode-safe/releases).
...
1. `$OPENCODE_SAFE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.opencode-safe/bin` - Alternativa por defecto
...
OpenCode Safe incluye dos agents integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agents](https://github.com/usamadar/opencode-safe#agents).

### Documentación

Para más información sobre cómo configurar OpenCode Safe, [**ve a nuestra documentación**](https://github.com/usamadar/opencode-safe#readme).

### Contribuir

Si te interesa contribuir a OpenCode Safe, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Construyendo sobre OpenCode Safe

Si estás trabajando en un proyecto relacionado con OpenCode Safe y usas "opencode-safe" como parte del nombre; por ejemplo, "opencode-safe-dashboard" u "opencode-safe-mobile", agrega una nota en tu README para aclarar que no está construido por el equipo de OpenCode Safe y que no está afiliado con nosotros de ninguna manera.
...
- 100% open source
- No está acoplado a ningún proveedor. Aunque recomendamos los modelos que ofrecemos a través de [OpenCode Safe](https://github.com/usamadar/opencode-safe#readme); OpenCode Safe se puede usar con Claude, OpenAI, Google o incluso modelos locales. A medida que evolucionan los modelos, las brechas se cerrarán y los precios bajarán, por lo que ser agnóstico al proveedor es importante.
- Soporte LSP listo para usar
- Un enfoque en la TUI. OpenCode Safe está construido por usuarios de neovim y los creadores de [terminal.shop](https://terminal.shop); vamos a empujar los límites de lo que es posible en la terminal.
- Arquitectura cliente/servidor. Esto, por ejemplo, permite ejecutar OpenCode Safe en tu computadora mientras lo controlas de forma remota desde una app móvil. Esto significa que el frontend TUI es solo uno de los posibles clientes.

---

**Únete a nuestra comunidad** [Discord](https://github.com/usamadar/opencode-safe/discussions) | [X.com](https://github.com/usamadar/opencode-safe)
